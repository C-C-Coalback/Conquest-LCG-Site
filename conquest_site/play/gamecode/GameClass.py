        ...
        if name == self.player_with_action:
            if len(game_update_string) == 1:
                ...
                if game_update_string[0] == "HAND":
                    ...
                    await self.update_game_event_action_hq(name, game_update_string)
            elif len(game_update_string) == 4:
                if game_update_string[0] == "IN_PLAY":
                    await self.update_game_event_action_in_play(name, game_update_string)
            elif len(game_update_string) == 5:
                if game_update_string[0] == "ATTACHMENT" and game_update_string[1] == "HQ":
                    await self.update_game_event_action_attachment_hq(name, game_update_string)
            elif len(game_update_string) == 6:
                if game_update_string[0] == "ATTACHMENT" and game_update_string[1] == "IN_PLAY":
                    await self.update_game_event_action_attachment_in_play(name, game_update_string)
